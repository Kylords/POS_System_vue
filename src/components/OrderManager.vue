...
<template>
    <div>
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li >
                <p class="continue" @click="createOrderPage">Create Order <i class="bi bi-arrow-right"></i> </p>
            </li>
        </ul>
                ...
                <div class="card rounded-3 mb-4">
                    <div v-for="product in order.products" class="card-body p-4" :key="product.id">
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-2 col-lg-2 col-xl-2">
                                <button class="btn btn-outline-primary" v-if="variables.status == 'Pending'" @click="changeStatus('Confirmed', Number(order.id))">Confirm Order</button>
                                <button class="btn btn-outline-success" v-else-if="variables.status == 'Confirmed'" @click="changeStatus('Completed', Number(order.id))">Complete Order</button>
                            </div>
